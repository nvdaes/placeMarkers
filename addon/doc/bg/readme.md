...
*	Добавката е съвместима с NVDA 2021.1 или по-нови версии (изисква се).
* Поддържа се бегло четене при навигиране до временни маркери.
*	Ако е необходимо, можете да изтеглите [други версии](https://github.com/nvdaes/placeMarkers/releases).
